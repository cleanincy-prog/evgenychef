## Цветное меню без рисования — 2026-09-13

Последний запрос отменяет карандаш, скролл-механику и переключатели режимов. Последующее «Оставь только осьминога» оставляет один лист без навигации, ширина до 640 px (половина прежнего разворота 1280 px), на mobile по доступной ширине. Меню всегда цветное, включая начальный HTML и reduced motion. Сохраняются лист #f8f5ee, действующие шрифты, фотографии и поля. После «Соль, перец, граммовки добавь» на листе десять позиций: четыре фото-компонента и шесть дополнительных текстовых ингредиентов с приготовлением перед тарелкой. Рядом с каждым названием количество; цифры используют PT Mono, единица измерения Ysabeau Office. Явно указана 1 порция и вес подготовленных продуктов. Дополнительный список использует текущие названия ≥19 px, текст 16 px и тонкую линию rule; две текстовые колонки на широком листе, одна до 620 px и на узком листе при увеличенном тексте. [Аудит и план](MENU_BOOK_COLOR_2026-09-13.md). Ниже — предыдущая механика.
