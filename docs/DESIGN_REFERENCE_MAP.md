...
| Расширенный состав | Прямые «добавь больше ингредиентов» и «Соль, перец, граммовки добавь», существующий рецепт | Десять компонентов с действиями и количеством на 1 порцию | Новые фантазийные изображения и изменение подачи | Четыре фото-компонента и шесть текстовых позиций, включая соль и перец |
