...
|---|---|---|---|---|
| Момент начала видео подготовки | Прямое уточнение пользователя и [снимок](../design/references/approved-video-start-position-2026-09-13.jpg) | Начать при полном появлении кадра с небольшим отступом от низа экрана | Панели телефона, фиксированная высота одного устройства, новая композиция | Полный кадр выше 94% видимой высоты; в коротком окне старт при достижении верхом ролика верха видимой страницы; после старта пауза только вне экрана |

Визуальная система прежняя. Техническая адаптация короткого экрана не имеет отдельного снимка и использует нейтральное правило максимально доступной видимости. [Аудит, план и проверка](VIDEO_START_POSITION_2026-09-13.md).
...
| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Первый экран Hero | Последнее прямое «В Хиро блоке текст не меняй, оставь как есть» и версия a15887d | Сохранить прежнее имя, заголовок, фото и геометрию | «Кого соберём за столом?», новый byline/intro и адаптация CSS | Точное восстановление прежнего hero-frame и CSS |
| Биография, форматы, этапы, подписи | Последняя полная редакция в чате, одобренная пользователем | Личный разговор с шефом и различие трёх форматов | Ранний черновик и неподтверждённые условия | Точный текст под первым экраном до конца «Ваш вечер» |
| Контакт и подвал | Прямое исключение «Евгений есть идея, и всё что после него не добавляй» | Сохранить действующий способ связи | Предложенные новые контакт/подвал | Исходные contact/footer без изменений |

[Аудит, план и результаты](APPROVED_COPY_2026-09-13.md). Новых визуальных решений нет; источники — существующая система и явное содержание.

## Видео при прокрутке — 2026-09-12

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Видео подготовки | Прямой запрос убрать кнопку и запускать при прокрутке; существующий фильм и «План вечера» | Сразу видимый inline-плеер с полным кадром 9:16, ранняя загрузка и запуск без звука | Стартовая накладка, изменение размера после запуска, новые декоративные решения | ChefStoryVideo + media-motion; пауза вне экрана, ручные controls, reduced motion |
| Короткое мытьё овощей | Прямой запрос; исходный документальный материал | Один короткий понятный план вместо повторов | Новые/генерированные сцены, изменение других эпизодов | Отдельный сокращённый MP4, оригинал сохранён |

[Аудит и проверка](VIDEO_SCROLL_2026-09-12.md).

## Исправление фамилии шефа — 2026-09-11

Прямой источник: пользователь уточнил «Фамилия шефа Гребеник».

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Имя на странице и доступные подписи | Прямое уточнение пользователя | Верное имя «Евгений Гребеник», латиницей Evgen Grebenik | Старое ошибочное написание | Текст header/Hero/footer, aria/alt |
| Метаданные и существующее превью ссылки | То же уточнение и существующий OG-ресурс | Согласованное имя в title/description/OG/Twitter/favicon | Новая визуальная концепция и старый неподтверждённый лимит гостей | Исправленные строки и точечная производная OG |

Композиция, гарнитуры, палитра и стикеры прежние; решений без источника нет. [Аудит и проверка](CHEF_SURNAME_2026-09-11.md).

## Вернуть выразительность выбранного бумажного макета — 2026-09-11

Пользователь указал, что версия699c96b менее выразительна, чем выбранный макет. Источник остаётся [«Бумажный край»](../design/references/approved-paper-edge-sticker-2026-09-11.png); это корректировка точности переноса.

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Толщина бумажного среза | Светлая кромка и тёмное прилегание в выбранном макете | Тонкая светлая грань рядом с нерегулярным контуром | Светлая заливка всей карточки | Новая версия SVG-кромки, прежний --paper |
| Тень слева и снизу | Видимая глубина листка в макете | Тень прилегания вдоль левого края с усилением снизу | Равномерный ореол со всех сторон и загиб | Более протяжённый нижний слой тени |
| Название и подчёркивание | Более плотный чёрный штрих и золотистая линия макета | Выраженная подпись на бумаге | Новая гарнитура или изменение текста | Локальный вес Caveat и толщина подчёркивания |

[Аудит, план и проверка](PAPER_EDGE_EXPRESSION_2026-09-11.md). Компоновка, фото, форма и общий фон подтверждены прежде.

## Выбран бумажный край стикера — 2026-09-11

«Давай этот» со screenshot файла exec-878146a3-368a-47b6-bf45-5c697a49664c.png утверждает [вариант «Бумажный край»](../design/references/approved-paper-edge-sticker-2026-09-11.png). Он заменяет прежнюю светлую оболочку; фото, текст и раскладка сохраняются.

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Фон стикера | Прямое уточнение пользователя и выбранный макет | Бумага в цвет страницы | Светлая заливка предыдущей версии, оттеночные погрешности растра | --paper #f4efe5 у бумажной основы и окна фото |
| Срез бумаги | Прямо выбранный «Бумажный край» | Простой прямоугольник, мягкие углы, мелкая нерегулярность | Фигурные выемки, волны, зубцы, плёнка, сгибы | Локальный геометрический SVG в ::before, не воздействующий на контент |
| Тень прилегания | Нижний левый край выбранного макета | Тонкая локальная тень материала | Равномерная тень карточки и большой загиб | Отдельный ::after под бумажной основой |
| Фото, подписи, сетка и mobile | Действующая утверждённая версия e0f7774 / Sites51 | Полный кадр 3:2, живой Caveat, безопасные поля при наклоне | Сгенерированное фото макета, новая композиция | Прежние изображения, разметка, размеры и брейкпоинты |

Неподтверждённых новых стилистических решений нет. [Аудит, план и итог](PAPER_EDGE_STICKERS_2026-09-11.md).

## Выбраны цельные фото-стикеры — 2026-09-11

Прямые «полноценные стикеры с подписью» и «Давай добавим на сайт» утверждают [последний макет](../design/references/approved-whole-stickers-2026-09-11.png). Даты отменены последующим «Или не надо». Предыдущие варианты ниже — история исследования.

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Оболочка услуги | Выбранный цельный стикер | Фото, название и описание на одной бумаге | Отдельные записки, холодильник, магниты, цифры, даты | Три li в ul, единая оболочка и живая подпись |
| Бумага, наклон и подчёркивания | Макет и прямой запрос стикеров/подчёркиваний | Узкий светлый край, контактная тень, мягкий угол, малый статический поворот | Stock-тема, крупная тень, анимация, печати, внешние рамки | Локальные CSS-правила .format-* и существующие цвета текста/Caveat |
| Фотографии и содержание | Три действующих файла и тексты выбранного макета | Полный кадр 3:2, исходные люди/сюжеты, альтернативы услуг | Перерисованные генератором лица, новые обещания, перекрытие текста | Прежние WebP384/768 и alt, обновлённый sizes |
| Телефон | Выбранный мобильный макет | Цельные стикеры в порядке чтения, небольшой наклон | Пересечения, мелкая подпись, исчезновение фото | Отдельные безопасные поля/размеры до620px |
| Desktop и планшет | Свободная композиция выбранного макета и реальное содержание | Крупные стикеры с асимметрией вместо трёх узких колонок | Прямое растяжение телефона, выдуманный новый стиль | Два со смещением и третий ниже по центру; до900px один ограниченный по ширине ряд чтения. Отдельного desktop-референса нет |

[Аудит, план, проверка и ограничения](FORMAT_STICKERS_2026-09-11.md).

## Выбран широкий снимок с кухней для публикации — 2026-09-11

Последние «Предыдущую просто растянутую» и «Отлично, добавь его на сайт» утверждают private-dinner-wide-v2.png. Домашний фон ниже — отклонённая проба. Внедряется именно выбранная производная, без новой генерации.

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Фото «Частный ужин» | Прямо выбранный пользователем private-dinner-wide-v2.png 1536×1024; действующая рамка форматов 3:2 | Заполнить общую рамку полным широким кадром, сохраняя пропорции | Домашний фон, отклонённые макеты, новый дизайн | Отдельный PNG и WebP 384/768; обновление источника только первой услуги |

Текущие Caveat, палитра, сетка, состояния, остальные фотографии и исходный портрет сохраняются. Новых компонентов, библиотек и решений без референса нет. [Аудит, план и результаты](PRIVATE_DINNER_WIDE_2026-09-11.md).

## Возврат исходного фона портрета — 2026-09-11

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Главное фото Hero | Прямое «верни пожалуйста» и предыдущая одобренная версия d1bd7a7 / Sites48 | Вернуть исходный уличный фон фотографии | Новая композиция или перерисовка | Возвращается исходный chef-hero-apron и его прежние WebP; прозрачный PNG сохраняется отдельно по просьбе пользователя |

Кремовая версия ниже — отклонённая историческая проба. Решений без источника, новых элементов и библиотек нет. [Аудит и план отката](HERO_CREAM_PORTRAIT_2026-09-11.md).

## Главное фото Hero на фоне текста — 2026-09-11

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Фон главного портрета | Прямой запрос «главное фото шефа … с кремовым фоном сайта, с фоном как у текста»; текущий `--paper #f4efe5` | Единое кремовое поле главного фото и соседнего текста | Уличное окружение и телефонный UI исходника; градиент, ореол, новый декор | PNG из исходных пикселей фото с прозрачным окружением показывает фон `hero-identity`; WebP 320/576 с alpha |
| Фигура шефа и размещение | Оригинал `public/media/chef-hero-apron.jpg`; действующий одобренный `hero-identity` | Сохранить лицо, улыбку, позу, одежду, пропорции и видимый кадр на desktop/mobile | Новая внешность, поза, коллаж, шрифт или композиция | Прежние компоненты, ширины, высоты, CSS-кадрирование, `alt` и приоритет загрузки; оригинал сохраняется |

[Аудит, предварительный план, реализация и проверка](HERO_CREAM_PORTRAIT_2026-09-11.md). Нативная маска macOS Vision и Swift-композиция сохраняют исходное лицо, одежду, позу и координаты фигуры без перерисовки; оригинал и прежние производные сохранены. Визуальный просмотр и сверка геометрии на 1440/1280/1024/768/430/390/375px — PASS: аккуратный кремовый стык, прежние контейнеры/заголовок и отсутствие overflow. Production build, пять HTTP-тестов и финальный anti-template аудит — PASS. Решений без источника нет.
...
| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Описание опыта шефа | Прямой текст пользователя, два абзаца | Дословная передача содержания | Новые факты или рекламные вставки | Два p.award-note под прежним award-title |
| Размещение описания | Одобренный award-proof и необходимость читать весь текст на телефоне | Сохранить фото/название, дать длинным абзацам полную доступную ширину | Скрытие текста на <=620px, новые украшения | Desktop прежний flex; mobile первый ряд фото36% + заголовок, затем два абзаца во всю ширину |

Аудит и план: [MASTERCHEF_TEXT_2026-09-11.md](MASTERCHEF_TEXT_2026-09-11.md). Решений без источника нет.

## Тёплое кремовое размытие Hero — 2026-09-11

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Фон Hero | Запрос: «Нужно ещё усилить… кремовый блюр… слегка оранжевый»; утверждённый бумажный фон | Сильнее смягчить коллаж и придать кремовый тон с оранжевым оттенком | Тонирование/размытие главного портрета и текста, градиенты и анимация | blur(2px) на hero-collage-grid и ровная вуаль rgb(246 224 196 / 24%) внутри hero-collage |

Это текущая трактовка запроса; прежние значения ниже — история. Новых компонентов или композиционных решений без референса нет.
...
| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Фон Hero | Уточнение пользователя: «лёгкий блюр, прям % 5» | Почти чёткие фоновые фото с минимальной мягкостью | Заметное размытие, фильтр портрета или текста | Уменьшить blur с 1.1px до 0.3px только на hero-collage-grid |

Ранее выполненный аудит и одобренная композиция остаются актуальными. CSS blur задаётся длиной; «5%» интерпретировано как субъективно едва заметный эффект, а не буквальная CSS-величина. Новых элементов и решений без источника нет.

## WebP и лёгкое размытие фонового коллажа — 2026-09-11

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Растровые изображения | Прямой запрос ускорить загрузку; текущие реальные исходники | Размер файла соответствует размеру изображения на странице | Новые/заменённые сцены и кадрирование | WebP-производные, responsive srcset, отдельные миниатюры 63 кадров |
| Фоновый Hero | Прямой запрос небольшого размытия с чётким портретом/текстом | Фоновая часть мягче, центральная идентичность чёткая | Размытие hero-frame или hero-identity, анимация | blur(1.1px) только на hero-collage-grid |

[Аудит, план и проверка](IMAGE_LOADING_2026-09-11.md). Все композиции прежние; новых решений без источника нет.

## Стабильный коллаж при прокрутке — 2026-09-11

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Высота компактного Hero | Новый запрос устранить рывки; одобренный Hero на первый экран; [предыдущий screenshot](../design/references/hero-mobile-viewport-2026-09-11/user-reference.jpg) | Первый экран заполнен, фотографии неподвижны внутри коллажа во время прокрутки | Пересчёт высоты по скрытию адресной строки | Сохранить 100svh минус header 80/72/74 px; убрать 100dvh |
| Фотографии, главный портрет и нижний ряд | Текущий одобренный интерфейс | Сохранить композицию и кадрирование | Параллакс, анимация, перестановки и новые эффекты | Прежние 63 фото, колонки, квадратный последний ряд и портрет |

[Причина, план и проверка](HERO_SCROLL_STABILITY_2026-09-11.md). Новых решений без источника нет. Эта правка заменяет прежнее техническое решение dvh, сохраняя исходный пользовательский замысел.

## Новое фото «МастерШеф» — 2026-09-11

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Фотография победителя | Присланное пользователем Photo 1.jpg; [оригинал](../public/media/masterchef/evgen-masterchef-user-2026-09-11.jpg) | Реальное документальное подтверждение, полное лицо и конверт | Старый кадр и его горизонтальная обрезка | Новый JPEG в основном блоке с пропорцией 1280:1160 и естественной высотой; прежняя ширина 23% / 36% |
| Ячейка коллажа с тем же событием | Та же фотография и действующий 63-фотографический коллаж | Согласовать повторяющееся фото | Новая композиция или изменение других кадров | Замена одного источника в прежней ячейке |

[Аудит и план](MASTERCHEF_PHOTO_2026-09-11.md). Решений без источника нет.

## Hero до нижней границы экрана — 2026-09-11

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Высота мобильного фотополя | Прямое «Хиро впритык», «для всех мобильных устройств» и [скриншот](../design/references/hero-mobile-viewport-2026-09-11/user-reference.jpg) | До прокрутки видны только header и Hero, высота следует доступной области браузера | Фиксированные размеры конкретного телефона и панели браузера | Минимум 100dvh минус header 80/72/74 px в прежних компактных брейкпоинтах до 1100/900/620 px; 100svh fallback; естественный поток при нехватке высоты |
| Текст, главное фото и нижний ряд | Одобренная текущая версия и предыдущий запрос квадратных фото | Сохранить верхний отступ, типографику, кадрирование и квадратный завершающий ряд | Растяжение основного портрета | Дополнительное пространство занимает существующий фотоколлаж |

Решений без источника нет. [Аудит и план](HERO_MOBILE_VIEWPORT_2026-09-11.md).

## Мобильный край Hero — 2026-09-11

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Отступ над текстом | Прямой запрос и [скриншот](../design/references/hero-mobile-edge-2026-09-11/user-reference.jpg) | Немного поднять текущий текстовый блок | Браузерные панели скриншота, масштабирование текста | Высота по содержимому; верхний отступ72–84px |
| Нижний ряд коллажа | Тот же screenshot и прямой запрос квадратных кадров по концу Hero | Один полный квадратный ряд после главного фото | Узкая полоска предпоследнего ряда под портретом |8 квадратов, прежний шов2px; нижняя граница совпадает с фотополем |

Аудит/план: [HERO_MOBILE_EDGE_2026-09-11.md](HERO_MOBILE_EDGE_2026-09-11.md). Остальные решения прежние. Нет решений без источника.

## Удаление видеокадров — 2026-09-11

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Фото коллажа | Прямое «Убери фото отрезанные с видео»; история медиа в DESIGN_AUDIT.md | Исключить извлечённые кадры, оставить63 самостоятельных источника | Film stills, posters, извлечения Reels, gallery-cooking |63 фото, без повторов; архивные файлы сохраняются |
| Заполнение рамки | Действующие10/8 колонок, широкие позиции, швы2px | Сохранить фотополе со всех сторон без пустот | Новые эффекты и стиль |17 двойных ячеек:10×8 desktop/tablet и8×10 phone; центр прежний |

Аудит/план: [HERO_PHOTOS_ONLY_2026-09-11.md](HERO_PHOTOS_ONLY_2026-09-11.md). Запрос заменяет прежнее количество94. Новых стилевых решений без источника нет.

## Большой коллаж — текущая правка 2026-09-11

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Полный фотоколлаж первого экрана | Прямой запрос; одобренная коллаж-рамка соседней Mise en place, page.tsx:9–78/274–305 и сохранённые hero-1440/390 | Все94 исходных фото, широкие и узкие ячейки, четыре стороны вокруг центра | Старый текстовый стиль, фильтры, подпись на портрете, остальные разделы | Один фоновый слой, 10×12 /12×10 /8×15, швы2px |
| Текст и ключевой портрет | Прямое «как сейчас написан текст и ключевое фото — оставь», существующая Шеф4 | Прежний Caveat, дословный текст/переносы, размеры и кадрирование портрета | Старые размеры/шрифты центрального блока | Исходный hero-identity поверх непрозрачной бумаги |

Новых решений без источника нет. Аудит и план: [HERO_LARGE_COLLAGE_2026-09-11.md](HERO_LARGE_COLLAGE_2026-09-11.md). Прежние записи о24/14 фотографиях заменены этим запросом.

Уточнение V8 после визуального просмотра: пунктир между «Меню» и «Подготовкой» огибает измеренные границы сцены «Разговор». Принцип взят из действующего маршрута на 1440 px; на 1280/1024 устраняется пересечение рисунка. Нового декоративного элемента нет.

## Одобренная сцена разговора V8 — 2026-09-11

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Шеф, блокнот, цветы и вода | Фото пользователя 11.21.14; одобрение показанных V7 и V8 | Взгляд вниз, лёгкая улыбка, единый карандаш, маленькая ваза и ровно два стакана | Кухня исходного фото, интерфейс снимка и отвергнутые лица | conversation-evgen-paper-flowers-v8.png, прежняя композиция 3:2 |
| Бумага рисунка | Прямое «фон картинки нужен под фон сайта», существующий --paper #F4EFE5 | Светлый фон сливается с бумагой страницы | Новая палитра, декоративная рамка | Прежние grayscale/contrast/multiply; контроль стыка на семи ширинах |

Подробности, одобрение и план: CHEF_CONVERSATION_V7_2026-09-11.md. Решений без референса нет.

## Одинаковые фотографии форматов без обрезки — 2026-09-11

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Фотографии трёх форматов | Прямое «они должны быть одного размера», уточнение «но не обрезаны»; прежние мобильные области мероприятий/мастер-классов 3:2 | Одинаковая область и полный пропорциональный кадр | Нет генерации, обрезки, искажений, декора и новых карточек | Единый 3:2, contain/center, бумажные поля при отличии пропорций; desktop до 270×180, mobile на всю ширину |

Решений без референса нет. Запрос сохранить весь кадр имеет приоритет над исторической рекомендацией кадрировать края фото мероприятий. Полный аудит/план: FORMAT_IMAGE_SIZES_2026-09-11.md.

## Актуальный возврат к Caveat — 2026-09-11

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Все заголовки и текст | Прямое «Верни предыдущий шрифт»; существующая версия до пробы Bad Script | Вернуть единый согласованный карандашный почерк и его размеры | Отменённая пара шрифтов, новая композиция | Удаление только добавленных правил Bad Script; исходный Caveat |

Новых решений без референса нет. Аудит, план и проверка — [FONT_PAIRING_2026-09-11.md](FONT_PAIRING_2026-09-11.md).

## История пробы пары шрифтов — 2026-09-11

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Hero h1 и крупные h2 / личное приглашение | Прямое «Давай попробуем» после предложения Bad Script для заголовков; показанный кириллический образец | Более тонкий личный почерк в акцентных фразах | Чужая композиция, искусственный курсив, сплошная смена шрифта | Локальный Bad Script 400 через отдельный --font-personal |
| Основной текст, h3, меню, кнопки, номера, подписи блюда | Согласованное сохранение текущего Caveat; существующий «План вечера» | Компактная привычная читаемость и понятные роли гарнитур | Случайное чередование шрифтов, изменение подписей через общий токен | Прежние --font-pencil / --font-display / --font-sans |

Решений без референса в этой правке нет. Аудит, план и итог: [FONT_PAIRING_2026-09-11.md](FONT_PAIRING_2026-09-11.md).

## Актуальная сцена разговора V7 — 2026-09-11

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Лицо и улыбка шефа | Новое фото пользователя 11.21.14; прямое требование слегка улыбаться | Точный наклон головы вниз, пропорции лица/бороды, едва заметная улыбка | Лицо отвергнутого V6, широкая улыбка с зубами, кухонный фон фото | Отдельный карандашный PNG в текущей сцене |
| Цветы и вода на столе | Прямое поручение пользователя | Небольшое украшение, два стакана воды для двух собеседников | Большой букет, винные бокалы, дополнительные предметы | Низкая маленькая ваза и ровно два стакана, не закрывающие блокнот/руки |

План и проверка: CHEF_CONVERSATION_V7_2026-09-11.md. Остальные решения сохраняют существующие источники.

## Кремовая тарелка с уткой — 2026-09-11

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Керамика тарелки в MenuPlate | Прямой запрос пользователя о кремовой тарелке с уткой; существующий --paper #F4EFE5; исходное фото personal-menu-duck-plate-cutout-v1.webp | Согласовать цвет керамики с бумажной гаммой, сохранить фотографический объём | Не заменять блюдо, не добавлять декор и не фильтровать весь снимок | Версионная локальная ретушь керамики; прежняя композиция, подписи и выноски. Аудит и план: CREAM_DUCK_PLATE_2026-09-11.md |

Решений без референса в этой правке нет. Разрешение на смену цвета относится только к керамике.
...
| Canapé field | Same reference's abundant wide lower food photograph; user's direct follow-up `много канапе` | Fill one wide supporting photograph with many distinct bite-size canapés and no second text hierarchy | No screenshot crop, copied food photograph, quantity claim, menu name, repeated card grid or reactivation of the event-circulation scene | Use the revised transparent 1774 × 887 `private-event-canapes-v3.webp`, with its dense three-row arrangement, as the decorative lower layer |
| Canapé surface and block fit | User's direct correction `Канапе не попадают ни в цвет ни в размер блока`; supplied phone capture; approved `--paper` surface | Let the exact block surface show between the food and make the photograph occupy the complete lower zone | No recolouring of the food, CSS filter, stretched bitmap, detached `2 / 1` phone tile or empty band before the lower rule | Remove the generated tabletop to alpha, place the food layer over the existing `var(--paper)` aperture and use `cover` inside a field that ends at the established 5% lower inset |
| Original image colour | User's direct correction `фото перекрасил, цвет убрал, а нужно было всего фон блока сделать в один цвет`; supplied current phone capture; approved `--paper` surface | Keep documentary and food evidence in natural colour while unifying the sheet through its containing surface | No grayscale, sepia, blend mode, tint overlay or reduced image opacity | Render the chef photograph and all canapé ingredients at full colour and opacity; the transparent spaces resolve to the exact surrounding paper without changing the food pixels |
...
| Responsive composition | Supplied phone reference; project's deliberate-mobile rule | Preserve the same three reading zones while giving the lower canapé field more depth on narrow screens | No mechanical one-column stack, horizontal scroll, clipped live copy or desktop-only proportions | Use a shallow landscape field on wide screens, a square tablet field and a slightly portrait phone field; copy and chef photograph remain side by side while the canapé aperture fills from its breakpoint-specific top edge to the shared 5% lower inset |
...
## Personal-menu annotated plate — direct composition reference — 2026-09-10

This entry supersedes the earlier personal-menu introduction, three-step sequence, sourcing gallery and
three short plate annotations. The supplied screenshot is a composition reference; the exact Russian copy
in the accompanying brief is authoritative whenever the screenshot differs.

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Complete chapter | User-supplied `Снимок экрана 2026-09-10 в 11.30.57.png` and exact-content brief | One continuous editorial explanation: conversation, composition rationale, annotated plate, one action | Browser chrome, screenshot pixels, embedded text, generic landing-page sections, sourcing gallery or step cards | Rebuild the existing `#products` section with live HTML and a responsive SVG leader layer; keep surrounding sections untouched |
| Opening statement | Same screenshot and exact-content brief | Large serif statement followed by calm explanatory copy and one hairline rule | Extra process labels, marketing promises, decorative fill or generic hero buttons | Keep the exact kicker, two-line heading and approved paragraph; use existing Cormorant/Montserrat roles and project tokens |
| `Как рождается блюдо` introduction | Same screenshot and exact-content brief | On wide screens, balance a display heading against explanatory copy across one vertical rule | Card, numbered stepper, icon, arrow sequence or mobile-scaled desktop row | Use a two-column editorial pair above 700 px; remove the vertical rule and stack the two texts below that breakpoint |
| Annotated plate | Same screenshot; existing approved `personal-menu-duck-plate-cutout-v1.webp`; user's follow-up to remove `Свежая зелень` | The plate is the chapter's visual centre and the remaining four chef-note callouts stay spatially tied to it | Whole screenshot as an image, text inside SVG, invented ingredients, replaced/random dish, crop through the ceramic rim or callout cards | Preserve the complete alpha plate and render four live-text notes around it; each responsive leader group contains four paths and endpoint dots |
| Ingredient truthfulness | User's explicit mismatch rule; visual inspection of the approved plate source | Describe the retained requested components but never claim a photographic match more exact than the available source supports | No generated additions, retouching, redirection to empty plate rim or statement that the source exactly matches the mockup | The orange purée-like elements and vegetable/mushroom garnish are the nearest visible targets for the purée and baked-vegetable notes; exact pale purée and carrot arrangement from the screenshot are not present and remain a disclosed limitation |
| Closing action | Same screenshot and existing `#contact` journey | A single restrained rectangular action closes the chapter, framed by horizontal rules on wide screens | New form, invented contact, second CTA, large empty tail, rounded pill or animated decoration | `ОБСУДИТЬ МЕНЮ` links to the unchanged `#contact` section and retains the global keyboard focus treatment |
| Mobile composition | Exact-content brief, separate-mobile-layout project rule and latest removal | Keep a large plate and distribute all four readable notes above and below it with connecting leaders | Hidden descriptions, hover disclosure, detached ingredient list, scaled desktop canvas or horizontal scrolling | At 620 px and below use a compact authored stage: two notes above and two below the plate; descriptions stay at least 14 px and the plate remains uncropped |

Decisions without a separate reference: exact breakpoint coordinates and the mapping of the current source's
...
The user's screenshot `Снимок экрана 2026-09-10 в 12.41.47.png` and accompanying explicit implementation brief supersede row 03's previous learning blueprint, photo-left layout, hidden numbering and phone two-column requirement. Existing user changes in the other event rows must be preserved.

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Section field and dividers | User screenshot/brief; existing paper/rule tokens and format-list container | Quiet warm editorial field, fine full-width rules, no cards | Screenshot chrome, preview badge, rounded screenshot frame, new page theme | Dedicated semantic MasterclassesSection inside the third format-list item; scoped classes and existing tokens |
| Upper copy and photograph | User screenshot/brief; approved masterclass.jpg and current Cormorant/Montserrat roles | Number 03 with short rule; large serif heading and readable paragraph left, documentary image right | Substitute chef from mockup, baked text, new claims, fixed text positioning | Natural-flow grid, exact requested copy, existing 1144 × 770 photograph with full aspect ratio |
| Six teaching stages | Explicit six-stage brief and lower band of supplied screenshot | Single continuous overhead linen scene; six evenly spaced subject groups with live captions | Individual cards, icons, borrowed food from another service, screenshot crop, raster labels | One original text-free illustrative food asset with an ordered HTML caption list: Нарезка, Замес, Лепка, Соусы, Обжарка, Подача |
| Phone layout | Explicit mobile brief; existing 560 px breakpoint and focus treatment | Copy then photograph; keep one readable composition through horizontal scrolling | Tiny six-column strip, six stacked cards, arrows or invented controls | Native labelled keyboard-focusable overflow region; visible short swipe instruction on phones, intrinsic scene width and no page overflow |

No new palette, typeface, radius, shadow, animation or UI library is required. Exact upper column shares, type clamps, scene minimum width and spacing are neutral fitting values bounded by the screenshot and checked at 1440, 1280, 1024, 768, 430, 390 and 375 px. The lower generated scene illustrates techniques; it does not document an actual event or promise a fixed menu.


## Masterclasses unified paper and drafting rules — 2026-09-10 follow-up

The user explicitly requests the same background as the section and line divisions like the existing private-dinner/private-event blocks. This supersedes only the linen backdrop of the newly approved technique composition and its minimal two-rail treatment.

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Technique background | Direct follow-up; live row-02 transparent canapé layer and `--paper: #f4efe5` | Objects sit on exactly the same surface as the complete section | Linen rectangle, baked approximation of paper, image tint/filter, food recolouring | Remove only the linen into real alpha and show the existing CSS paper through it |
| Perimeter and horizontal bands | Existing `.format-event-drafting-frame`, `.format-event-drafting-rule` and private-dinner rails, named by user | Fine inset square perimeter, upper/lower rails and separator between copy/photo and the technique scene | Card styling, rounded corners, shadows, extra graphics or labels | Scoped CSS frame and 1 px `--rule` borders fitted to normal-flow content |
| Copy/photo seam | Existing private-event vertical drafting spine | Rule occupies the quiet gap between different content roles | Technical arrows, labelled axis, circles or per-technique card boxes | One 1 px vertical divider on two-column layouts; one horizontal divider between copy and photograph on phones |

All visible changes are grounded in the user's specified neighbouring blocks. Existing typography, wording, photo, six objects/captions and mobile scrolling remain. Exact rail spacing is a neutral fit of those existing rules to this section's content-derived height, not a new style.

## Masterclasses responsive adaptation — 2026-09-10

This amendment supersedes only the previous 560 px / 900 px phone scrolling treatment.

| Project element | Reference | Principle used | What is not copied | Project implementation |
|---|---|---|---|---|
| Wide layout | User's original screenshot and existing masterclasses composition | Copy/photo columns above one six-stage panorama | New theme or arbitrary type scale | Preserve full photograph and fluid existing display/body sizes above 700 px |
| Mobile techniques | Original brief explicitly allows careful rearrangement; current request; approved private-dinner mobile course strips | Show all stages in two continuous rows on one paper field | Individual cards, six stacked tiles, hidden stages, fabricated imagery | Two CSS apertures showing stages 1–3 and 4–6 from the existing transparent scene, with live ordered captions |
