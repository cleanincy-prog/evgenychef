...
const source = new URL("design/references/approved-chef-menu-2026-09-14.png", root);
...
for (const width of [640, 960, 1536]) {
  ...
  const filename = `scene-${width}.webp`;
...
await writeFile(new URL("design/references/approved-chef-menu-2026-09-14.manifest.json", root), JSON.stringify({
  source: "design/references/approved-chef-menu-2026-09-14.png",
  selectedFrom: "design/mockups/chef-menu-copy-2026-09-14/chef-menu-copy.png",
  sourceSha256: createHash("sha256").update(original).digest("hex"),
  width: metadata.width, height: metadata.height,
  operation: "Proportional responsive WebP encoding only; no regeneration or content edits",
  variants,
}, null, 2) + "\n");
