...
test("serves the approved evening page as accessible Russian HTML", () => {
  ...
  for (const expected of ["Евгений", "Гребеник", "Mise en place", "Кого соберём", "Знакомимся", "Продумываю меню", "Готовлю к встрече", "Ваш вечер", "Начнём с вашего вечера", "Основной продукт", "Гарнир", "Текстуры", "Соус"]) {
